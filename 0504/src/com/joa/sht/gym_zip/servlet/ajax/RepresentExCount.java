...
@WebServlet("/searchRepresentExerciseCount.json")
public class RepresentExCount extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//운동필터 객체 생성
		ReExerciseFilter ef = new ReExerciseFilter();
		...
		ef.setBody(part[6]);
		Count count = RepresentExercisesDAO.selectFilterCount(ef);
