...
@WebServlet("/rejectCoaching.json")
public class RejectCoaching extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Coaching coaching = new Coaching(coachNo, coachingDate, rejectReason);
		
		int result = CoachingDAO.rejectCoaching(coaching);
