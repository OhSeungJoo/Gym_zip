...
@WebServlet("/ajax/lectureListFilter.json")
public class GetLectureCardList extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// TODO Auto-generated method stub
		// sort:sort,level:level,gender:gender,timeRangeStart:time[0], timeRangeEnd:time[1]
		...
		//강의 필터 객체 생성 
		LectureListFilter lectureListFilter=new LectureListFilter(pageNo,numPage);
		...
		List<Lecture> list = LectureDAO.selectLectureCardList(lectureListFilter);
